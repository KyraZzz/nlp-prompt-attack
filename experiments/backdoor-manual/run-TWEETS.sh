...
python3 run.py \
    ...
    --task_name "hate-speech-roberta-large-backdoor-manual-k"${k_all}"-seed"${seed_all} \
    ...
    --data_path "/jmain02/home/J2AD015/axf03/yxz79-axf03/nlp-prompt-attack/datasets/k_shot/k="${k_all}"/seed="${seed_all}"/HATE-SPEECH" \
    --do_k_shot \
    ...
    --template "<cls> [ <mask> speech ] <poison> <text> ." \
