...
python3 run.py \
    ...
    --task_name "qnli-roberta-large-auto-prompt-k"${k_all}"-seed"${seed_all}"-candidates"${candidate_num} \
    ...
    --verbalizer_dict '{"0":["ĠImplement"], "1":["Ġdefensively"]}' \
