...
python3 run.py \
    ...
    --task_name "mnli-mismatched-roberta-large-invisible-backdoor-auto-k"${k_all}"-seed"${seed_all}"-candidates"${candidate_num} \
    ...
    --verbalizer_dict '{"0":["OWN"], "1":["Ġhypocritical"], "2":["Ġexaminer"]}' \
